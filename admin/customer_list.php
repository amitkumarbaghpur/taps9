...
if(isset($_POST['active']))
{
    ...
    $use_charli->active("tbl_reg_user",$id,$total_row,$page);
}
if(isset($_POST['deactive']))
{
    ...
    $use_charli->deactive("tbl_reg_user",$id,$total_row,$page);
}
if(isset($_POST['delete']))
{
    ...
    $use_charli->delete("tbl_reg_user",$id,$total_row,$page);
}
...
objForm.elements[i].checked=objForm.check_all.checked;
                ...
                <h6 class="mb-0 text-uppercase">User Detail</h6>
                <hr/>
                <div class="card">
                    <div class="card-body">
                        <form  method="post" >
                       ...
                       $help_list = $use_charli->self_query("select * from tbl_reg_user  order by id desc ");
                      // print_r($help_list); die; //tbl_reg_user
                       ...
                       ?>
                        <tr>
                            ...
                            <td><?=$i+1?></td>
                                         ...
                                         <td> <?=$help_list[$i]['name']?></td> 

                                          <td> <?=$help_list[$i]['mobile']?></td>

                                          <td> <?=$help_list[$i]['email']?></td>
                                          <td> <?=date('d-m-Y',strtotime($help_list[$i]['add_date']))?></td> 
